...
summary: 'Entender os layouts típicos de janelas ajuda você a navegar e usar o Active IQ Unified Manager de forma eficaz.  A maioria das janelas do Unified Manager são semelhantes a um dos dois layouts gerais: lista de objetos ou detalhes.  A configuração de exibição recomendada é de pelo menos 1280 por 1024 pixels.' 
---
= Layouts típicos de janelas
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Entender os layouts típicos de janelas ajuda você a navegar e usar o Active IQ Unified Manager de forma eficaz.  A maioria das janelas do Unified Manager são semelhantes a um dos dois layouts gerais: lista de objetos ou detalhes.  A configuração de exibição recomendada é de pelo menos 1280 por 1024 pixels.

Nem todas as janelas contêm todos os elementos dos diagramas a seguir.
