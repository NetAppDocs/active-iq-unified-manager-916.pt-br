...
summary: Por motivos de segurança, você deve alterar a senha padrão do usuário umadmin do Unified Manager imediatamente após concluir o processo de instalação.  Se necessário, você pode alterar a senha novamente a qualquer momento. 
---
...
.Passos
. Efetue login como usuário root no sistema Linux no qual o Unified Manager está sendo executado.
. Alterar a senha do umadmin:
+
`passwd umadmin`
