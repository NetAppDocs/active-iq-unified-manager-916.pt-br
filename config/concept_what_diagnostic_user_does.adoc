...
summary: O objetivo do acesso de diagnóstico é permitir que o suporte técnico auxilie você na solução de problemas, e você só deve usá-lo quando instruído pelo suporte técnico. 
---
