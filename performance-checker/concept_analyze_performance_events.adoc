...
summary: 'Você pode analisar eventos de desempenho para identificar quando eles foram detectados, se estão ativos (novos ou reconhecidos) ou obsoletos, as cargas de trabalho e os componentes do cluster envolvidos e as opções para resolver os eventos por conta própria.' 
---
