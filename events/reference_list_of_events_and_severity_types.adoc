...
summary: Você pode usar a lista de eventos para se familiarizar mais com as categorias de eventos, os nomes dos eventos e o tipo de gravidade de cada evento que você pode ver no Unified Manager.  Os eventos são listados em ordem alfabética por categoria de objeto. 
---
