...
summary: A página Scripts permite que você adicione seus scripts personalizados ao Unified Manager.  Você pode associar esses scripts a alertas para habilitar a reconfiguração automática de objetos de armazenamento. 
---
= Página de scripts
:allow-uri-read: 
:icons: font
