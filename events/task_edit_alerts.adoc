...
summary: Você pode editar propriedades de alerta, como o recurso ao qual o alerta está associado, eventos, destinatários, opções de notificação, frequência de notificação e scripts associados. 
---
= Editar alertas
:allow-uri-read: 
:icons: font
...
. Na caixa de diálogo *Editar alerta*, edite as seções de nome, recursos, eventos e ações, conforme necessário.
+
