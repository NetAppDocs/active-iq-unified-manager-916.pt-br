...
summary: Você deve configurar alertas para receber notificações sobre eventos usando a caixa de diálogo Adicionar alerta.  Você também pode visualizar a lista de alertas na página Configuração de alertas. 
---
